...
<div style="float: left;display: flex;flex-wrap: wrap;width: 75%;justify-content: space-between;">
    ...
    <div style="width: 45%;font-weight: 500;color: #4c4c4c;font-size: 14px;margin: 5px;">出生年月： 2003-2</div>
    <div style="width: 45%;font-weight: 500;color: #4c4c4c;font-size: 14px;margin: 5px;">籍贯： 浙江台州</div>
    <div style="width: 45%;font-weight: 500;color: #4c4c4c;font-size: 14px;margin: 5px;">邮箱： wky32768@hdu.edu.cn</div>
    <div style="width: 45%;font-weight: 500;color: #4c4c4c;font-size: 14px;margin: 5px;">专业： 计算机科学与技术</div>
</div>
<div>
...
六级 206+156+167=529(22.6)

205+190+157=552(22.12)
...
C++, C, Python, Pascal, LaTeX, Markdown, Java, Matlab, Go
